        ...
        <section className="relative bg-black min-h-screen overflow-hidden">
            ...
            <div className="relative max-w-[1200px] mx-auto px-6 lg:px-12 py-24 z-10">
                <div className="text-center mb-12">
                    ...
                    <p className="font-body text-xl text-white/80 mb-2">6 washes per month</p>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {washOptions.map((option) => (
                        ...
                        >
                            {option.isFeatured && (
                                <div className="absolute -top-px right-8 bg-[#C9A961] text-xs font-bold px-5 py-2 rounded-b-lg shadow-lg uppercase tracking-wider text-black">
                                    Recommended
                                </div>
                            )}
                            ...
                            <Link
                                href={`/membership-registration?plan=elite&type=${option.type}`}
