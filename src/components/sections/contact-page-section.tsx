          ...
          <div className="w-full lg:w-[45%] mt-12 lg:mt-0">
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex justify-center gap-6">
                ...
                <a href="https://www.tiktok.com/@autobella_carwash" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white/60 hover:text-[#C9A961] transition-colors hover:scale-110 transform duration-200">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
