...
const faqData = [
  {
    ...
    answer:
      "We currently operate in Nasr City, Heliopolis, 1st Settlement, 5th Settlement, Qattamia, Shorouk, and Madinaty. We’ll be expanding soon to 6th of October and Sheikh Zayed.",
  },
  {
    id: "item-2",
